...
while 1:
	try:
		...
		print(l1 (u"ࠫࠥࡄࠠࡑ࡮ࡨࡥࡸ࡫ࠠࡘࡣ࡬ࡸࠥ࡝ࡨࡪ࡮ࡨࠤࡹ࡮ࡥࠡࡒࡵࡳ࡬ࡸࡡ࡮ࠢࡌࡲࡸࡺࡡ࡭࡮ࡶࠤࡹ࡮ࡥࠡࡆࡨࡴࡪࡴࡤࡦࡰࡦ࡭ࡪࡹ࠮ࠡࡖࡋࡍࡘࠦࡍࡊࡉࡋࡘ࡚ࠥࡁࡌࡇࠣࡅࠥࡒࡏࡏࡉࠣࡘࡎࡓࡅ࠯ࠩࠀ"))
	...
	def l11l1ll(self, l1l1lll=None):
		while 1:
			try:
				...
				print(Fore.RED + Style.DIM + l1 (u"ࠪࡠࡳࠦ࠾࡛ࠡࡲࡹࠥ࡮ࡡࡷࡧࠣࡆࡪ࡫࡮ࠡࡄ࡯ࡥࡨࡱ࡬ࡪࡵࡷࡩࡩࠦࡦࡳࡱࡰࠤࡌࡵ࡯ࡨ࡮ࡨ࠲ࠥࡕࡰࡦࡰࠣࠫ࠰") + Style.BRIGHT + l11 + Style.DIM + l1 (u"ࠫࠥ࡯࡮ࠡࡈ࡬ࡶࡪ࡬࡯ࡹࠢࡤࡲࡩࠦࡅ࡯ࡶࡨࡶࠥࡺࡨࡦࠢࡆࡳࡳࡺࡥ࡯ࡶࠣࡳ࡫ࠦࡴࡩࡧࠣࡋࡔࡕࡇࡍࡇࡢࡅࡇ࡛ࡓࡆࡡࡈ࡜ࡊࡓࡐࡕࡋࡒࡒࠥࡉ࡯ࡰ࡭࡬ࡩ࠳ࠦࡃࡐࡑࡎࡍࡊ࡙ࠠࡏࡑࡗࠤ࡜ࡕࡒࡌࡋࡑࡋ࠳࠭࠱") + Style.RESET_ALL)
				break
	def l1l1(self):
		chars = l1 (u"ࠬ࠵࠭࡝࡞ࡿࠫ࠲")
		for char in chars:
...
class l11l1ll1:
	def __init__(self, filename):
		...
		self.s.headers.update(self.l1l1l)
		self.l1l111l = re.compile(l1 (u"ࠪࡢࡠࡧ࠭ࡻࡃ࠰࡞࠵࠳࠹࠯ࡡ࠰ࡡ࠰ࡆ࡛ࡢ࠯ࡽࡅ࠲ࡠ࠰࠮࠻࠰ࡡ࠰ࡢ࡜࠯࡝ࡤ࠱ࡿࡇ࡛࠭࠰ࡠࡿ࠷࠲࠹ࡾࠦࠪࡅ"), re.IGNORECASE)
	...
	def l1lll111(self, links):
						...
						if l1 (u"ࠫࡅ࠭ࡔ") in line:
							...
							if self.l1l111l.match(l1l1ll1):
								if self.l11ll111.match(l11ll1ll):
									...
									l11ll1.write(l11l1lll + l1 (u"ࠩ࡟ࡲ࡙ࠬ"))
									i = i + 1
									self.n = self.n + 1
				print(Fore.GREEN + Style.NORMAL + l1 (u"ࠪࠤࡃࠦࡆࡰࡷࡱࡨ࡚ࠥ࠭") + str(i) + l1 (u"ࠫࠥࡉ࡯࡮ࡤࡲࡷࠥ࡯࡮ࠡࡖ࡫࡭ࡸࠦࡌࡪࡰ࡮࠲࡛ࠬ"))
		...
		print(Fore.GREEN + Style.NORMAL + l1 (u"ࠪࠤࡃࠦࡓࡢࡸࡨࡨ࡙ࠥࡵࡤࡥࡨࡷࡸ࡬ࡵ࡭࡮ࡼ࠲ࠬࡡ"))
...
def l1llll11():
	...
	if os.path.isdir(l11111l + l1 (u"ࠫࡸࡺ࡯ࡳࡣࡪࡩࠬࡩ")):
		print(Fore.GREEN + l1 (u"ࠬࠦ࠾ࠡࡕࡸࡧࡨ࡫ࡳࡴࡨࡸࡰࡱࡿࠠࡆࡵࡷࡥࡧࡲࡩࡴࡪࡨࡨ࡙ࠥࡴࡰࡴࡤ࡫ࡪ࠴ࠧࡪ"))
...
def l11ll1l(l11lll1l):
	if l11lll1l != l1 (u"ࠫࡦ࡜ࡡࡅࡃࠣ࡯ࡊࡊࡡࡗࡴࡄࠫࡷ"):
		...
		if l1l11 > l11lll1l:
			...
			print(Fore.GREEN + Style.BRIGHT + l1 (u"ࠧࠡࡀ࡙ࠣࡵࡪࡡࡵࡧࠣࡅࡻࡧࡩ࡭ࡣࡥࡰࡪ࠴࡜࡯ࠩࡺ"))
			time.sleep(0.7)
			l1l11l1 = input(Fore.GREEN + Style.NORMAL + l1 (u"ࠨࠢࡁࠤࡈ࡮ࡡ࡯ࡩࡨࡰࡴ࡭࠺ࠡ࡞ࡱࡠࡳ࠭ࡻ") + Style.DIM + l1l1lll1 + Fore.YELLOW + Style.BRIGHT + l1 (u"ࠩ࡟ࡲࡡࡴࠠ࠿ࠢࡇࡳࠥ࡟࡯ࡶ࡚ࠢࡥࡳࡺࠠࡵࡱ࡙ࠣࡵࡪࡡࡵࡧࠣࡒࡴࡽ࠿ࠡ࡝ࠪࡼ") + Fore.GREEN + l1 (u"ࠪ࡝ࠬࡽ") + Fore.YELLOW + l1 (u"ࠫ࠴࠭ࡾ") + Fore.RED + l1 (u"ࠬࡔࠧࡿ") + Fore.YELLOW + l1 (u"࠭࡝ࠡࠩࢀ") + Style.RESET_ALL)
			if l1l11l1.lower() == l1 (u"ࠧࡺࠩࢁ"):
				...
				print(Fore.GREEN + Style.BRIGHT + l1 (u"ࠬࠦ࠾ࠡࡒ࡯ࡩࡦࡹࡥࠡࡔࡨࡷࡹࡧࡲࡵࠢࡷ࡬ࡪࠦࡐࡳࡱࡪࡶࡦࡳࠠࡵࡱࠣࡍࡳࡩ࡯ࡳࡲࡲࡶࡦࡺࡥࠡࡶ࡫ࡩ࡛ࠥࡰࡥࡣࡷࡩ࠳࠭ࢆ"))
		elif l1l11 == l11lll1l:
			print(Fore.GREEN + Style.DIM + l1 (u"ࠨࠠ࠿ࠢ࡜ࡳࡺ࠭ࡲࡦࠢࡄࡰࡷ࡫ࡡࡥࡻࠣࡳࡳࠦࡴࡩࡧࠣࡐࡦࡺࡥࡴࡶ࡚ࠣࡪࡸࡳࡪࡱࡱ࠲ࠥࡉࡨࡦࡧࡵࡷࠦࠨࢇ"))
		elif l1l11 < l11lll1l:
			l1llll1l = os.getcwd()
...
def l11ll11l():
	...
	print(Fore.RED + Style.BRIGHT + l1 (u"ࠩࠣࡂࠥࡇࡵࡵࡪࡲࡶ࡮ࢀࡡࡵ࡫ࡲࡲࠥࡘࡥࡲࡷ࡬ࡶࡪࡪ࠮ࠡࡒ࡯ࡩࡦࡹࡥࠡࡘࡨࡶ࡮࡬ࡹ࡛ࠡࡲࡹࡷࠦࡃࡳࡧࡧࡩࡳࡺࡩࡢ࡮ࡶ࠲ࠬ࢘"))
...
try:
	...
	while 1:
		try:
			...
			l11l11l1 = l1ll1ll1.select(l1 (u"ࠩࠣࡂࠥࡖ࡬ࡦࡣࡶࡩ࡙ࠥࡥ࡭ࡧࡦࡸࠥࡺࡨࡦࠢࡇࡩࡸ࡯ࡲࡦࡦࠣࡊ࡮ࡲࡥ࠯ࠩࢻ"))
	...
	for l11l in l11l1l11:
		...
		elif l1l1llll == l1 (u"ࠪࡔࡦࡹࡴ࡛ࠡࡨࡥࡷ࠭ࣟ"):
			l11ll1l1[l11l] = l1 (u"ࠫࡾ࠭࣠")
		else:
			l11ll1l1[l11l] = l1 (u"ࠬࢀࠧ࣡")
		print(Fore.GREEN + Style.DIM + l1 (u"࠭ࠠ࠿ࠢࡉ࡭ࡳࡪࡩ࡯ࡩࠣࡖࡪࡹࡵ࡭ࡶࡶࠤࡴ࡬ࠠࠨ࣢") + Style.NORMAL + l1l1llll + Style.DIM + l1 (u"ࠧࠡࡨࡲࡶࣣࠥ࠭") + Fore.GREEN + Style.NORMAL + l11l + Fore.GREEN + Style.DIM + l1 (u"ࠨ࠰ࠪࣤ"))
	while True:
		try:
			l1l1l11 = input(Fore.GREEN + Style.DIM + l1 (u"ࠩࠣࡂࠥࡋ࡮ࡵࡧࡵࠤࡋ࡯࡬ࡦࠢࡑࡥࡲ࡫ࠠࡵࡱࠣࡗࡹࡵࡲࡦࠢࡆࡳࡲࡨ࡯ࠡࡎ࡬ࡷࡹࠦ࠺ࠡࠩࣥ") + Style.RESET_ALL + Style.DIM)
			if l1l1l11 == l1 (u"ࣦࠪࠫ") or l1l1l11 == None:
				raise l11l1l1
			else:
				if l1 (u"ࠫ࠳ࡺࡸࡵࠩࣧ") not in l1l1l11:
					l1l1l11 = l1l1l11.strip() + l1 (u"ࠬ࠴ࡴࡹࡶࠪࣨ")
				l11ll11 = l1ll11l1 + l1 (u"࠭ࡃࡰ࡯ࡥࡳࡑ࡯ࡳࡵࡵ࠲ࣩࠫ") + l1l1l11
			...
			if l11l111.lower() == l1 (u"ࠪࡽࡪࡹ࣭ࠧ"):
				print(Fore.RED + Style.DIM + l1 (u"ࠫࠥࡄࠠࡐࡸࡨࡶࡼࡸࡩࡵ࡫ࡱ࡫ࠥࡌࡩ࡭ࡧ࠱࣮ࠫ"))
				os.system(l1 (u"ࠬࡸ࡭࣯ࠡࠩ") + l11ll11)
				break
			else:
				continue
		except l11l1l1:
			print(Fore.RED + Style.NORMAL + l1 (u"࠭ࠠ࠿ࠢࡌࡲࡻࡧ࡬ࡪࡦࠣࡍࡳࡶࡵࡵ࠰ࣰࠣࠫ") + Style.RESET_ALL)
			continue
	for l1l11111 in l1ll111l:
		try:
			for l11l in l11l1l11:
				if l11l == l1 (u"ࠧࡈࡱࡲ࡫ࡱ࡫ࣱࠧ"):
					print(Fore.GREEN + Style.DIM + l1 (u"ࠨࠢࡁࠤࡠࡍ࡯ࡰࡩ࡯ࡩࡢࠦࡓࡤࡴࡤࡴ࡮ࡴࡧࠡࡍࡨࡽࡼࡵࡲࡥࠢ࠽ࠤࣲࠬ") + Style.BRIGHT + str(l1l11111) + Style.RESET_ALL)
					time.sleep(1)
			...
			break
	print(Fore.GREEN + Style.NORMAL + l1 (u"ࠨࠢࡁࠤࡘࡩࡲࡢࡲ࡬ࡲ࡬ࠦࡃࡰ࡯ࡳࡰࡪࡺࡥ࠯ࣹࠢࠪ") + Fore.CYAN + Style.BRIGHT + str(len(l11l1)) + Fore.GREEN + Style.NORMAL + l1 (u"࡙ࠩࠣࡗࡒࡳࠡࡈࡲࡹࡳࡪ࠮ࠨࣺ"))
	l11l1 = l1ll1l11.I1(l11l1)
	print(Fore.GREEN + Style.NORMAL + l1 (u"ࠪࠤࡃࠦࡃ࡭ࡧࡤࡲ࡮ࡴࡧࠡࡗࡕࡐࡸࠦࠦࠡࡔࡨࡱࡴࡼࡩ࡯ࡩࠣࡈࡺࡶ࡬ࡪࡥࡤࡸࡪࡹ࠮ࠡࠩࣻ") + Fore.CYAN + Style.BRIGHT + str(len(l11l1)) + Fore.GREEN + Style.NORMAL + l1 (u"࡛ࠫࠥࡒࡍࡵࠣࡖࡪࡳࡡࡪࡰ࠱ࠫࣼ"))
